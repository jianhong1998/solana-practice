...
export function getCruddappProgram(
  ...
  return new Program(
    {
      ...CruddappIDL,
      address: address ? address.toBase58() : CruddappIDL.address,
    } as Cruddapp,
    provider
  );
}
...
export function getCruddappProgramId(cluster: Cluster) {
  switch (cluster) {
    ...
    case 'testnet':
      ...
      return new PublicKey('Da93sUeitPGg2w9b7G44LSRHDDwVuo2MaCxSuabvXGnc');
    case 'mainnet-beta':
    default:
