...
export type Stablecoin = {
  "address": "3cXYz6evVwR2PYHqLgN6eY7TKhkqKep6eYrMFkBY9khc",
  "metadata": {
    "name": "stablecoin",
    "version": "0.1.0",
    "spec": "0.1.0",
  ...
  "instructions": [
    {
      "name": "depositCollateralAndMintToken",
      "discriminator": [
        103,
        183,
        132,
    ...
    {
      "name": "redeemCollateralAndBurnToken",
      "discriminator": [
        231,
        130,
        107,
  ...
  "errors": [
    ...
    {
      "code": 6001,
      "name": "belowMinHealthFactor",
      "msg": "Below minimum health factor"
    },
    {
      "code": 6002,
      "name": "aboveMinHealthFactor",
